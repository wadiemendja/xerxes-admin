function renderHeader(service = "Admin") {
  return `
    ...
    <div class="container-fluid">
      <a class="navbar-brand" href="${service != 'Admin' ? './service.html?service=' + service : '/'}">
        <img src="./img/logo.jpg" alt="Bootstrap" width="30" height="24">
        <a class="navbar-brand" href="" id="title">${service != 'Admin' ? 'Service ' + service : service}</a>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="${service != 'Admin' ? './service.html?service=' + service : '/'}">Accueil [demandes]</a>
          </li>
          <li class="nav-item">
